...
import com.xawen666x.myvpnstudy.adapter.ServerListRVAdapter;
...
import com.xawen666x.myvpnstudy.Utils;
...
public class MainActivity extends AppCompatActivity implements NavItemClickListener {
    ...
    public static final String TAG = "MyVpnStudy";
    @Override
    ...
    /**
     * Генерация массива списка серверов
     */
    private ArrayList getServerList() {
        ...
        servers.add(new Server("Нидерланды",
                Utils.getImgURL(R.drawable.netherland),
                "awen-aeza-server.ovpn",
                "awen-aeza-server",
                ""
        ));
    ...
    /**
     * При нажатии на панель навигации закрыть панель и изменить сервер.
